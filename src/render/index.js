...
import { envMaps, models } from "./render.config.js";
...
let renderer: WebGLRenderer, orthoCamera: OrthographicCamera, perspectiveCamera: PerspectiveCamera, activeCamera;
let ptRenderer: PathTracingRenderer, fsQuad: FullScreenQuad, controls, scene: Scene;
let envMap, envMapGenerator, backgroundMap: GradientEquirectTexture;
...
// 初始化
export default async function init({ canvasId, loadingId, samplesId, creditId }: IInit) {
	// 获取容器
	canvasEl = document.getElementById(canvasId)
	loadingEl = document.getElementById(loadingId)
	samplesEl = document.getElementById(samplesId)
	creditEl = document.getElementById(creditId)
