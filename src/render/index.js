...
import { modelList, envMaps } from './render.config';
...
export default async function init({canvasId, loadingId, samplesId, creditId}) {
	...
	renderer = new WebGLRenderer( {canvas: document.getElementById(canvasId), antialias: true } );
