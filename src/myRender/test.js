...
import { PathTracingRenderer } from "@/render/src/core/PathTracingRenderer";
...
// 容器
let loadingEl, samplesEl, canvasEl;
// 渲染器
let renderer, ptRenderer
// 场景
let scene, sceneInfo
// 相机, 控制器
...
let fsQuad
// 背景
let envMap, backgroundMap, envMapGenerator
// 辅助
let floorPlane, stats, gui
// 状态
let loadingModel = false, delaySamples = 0

// 初始化
export default async function init({ canvasId, loadingId, samplesId }) {
	// 获取容器
